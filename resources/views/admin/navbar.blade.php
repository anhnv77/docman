            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- Dashboard -->
                        <li >
                            <a class= "{{ Request::is('admin/dashboard') ? 'seeing-li active' : ''}}" href="{{ url('admin/dashboard') }}">
                        ...
                        <!-- Quản lý User -->
                        <li >
                            <a class = "{{ Request::is('admin/users') || Request::is('admin/users/create') || Request::is('admin/users/*')? 'seeing-li active' : ''}}" href="#">
                        ...
                        <!-- Quản lý Tài Liệu -->
                        <li >
                            <a class = "{{ Request::is('document') || Request::is('document/*') || Request::is('document/create') || Request::is('document/edit/*') ? 'seeing-li active' : ''}}" href="#">
                        ...
                        @if (auth()->check() && Auth::user()->hasRole('admin'))
                        <li >
                            <a class = "{{ Request::is('admin/departments') || Request::is('admin/departments/create') || Request::is('admin/departments/edit/*') ? 'seeing-li active' : ''}}" href="#">
                        ...
                        <li>
                            <a class="{{ Request::is('admin/typedocuments') || Request::is('admin/typedocuments/create') ? 'seeing-li active' : ''}}" href="#">
                                <i class="fa fa-book" aria-hidden="true"></i> &nbsp 
                        ...
                        <li>
                            <a class="{{ Request::is('admin/logs') ? 'seeing-li active' : ''}}" href="{{URL('admin/logs')}}">
                        ...
                        <li >
                            <a class = "{{ Request::is('manager/users') || Request::is('manager/documents') ? 'seeing-li active' : ''}}" href="#">
